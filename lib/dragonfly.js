...
var debug = require('debug')('dragonfly:repo')
  , error = require('tea-error')
  , params = require('params')
  , properties = require('pathval');
...
var clean = params.exclude('message', 'name', 'stack')
...
Dragonfly.prototype.create = function (key, _props, ssf) {
  ...
  var message = _props.message || def.message()
    , props = params.extend({}, def._props, clean(_props))
    , err;
